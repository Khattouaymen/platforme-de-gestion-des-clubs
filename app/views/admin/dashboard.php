        ...
        <div class="col-md-6 col-lg-3">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo isset($asset) ? $asset('admin/clubs') : '/admin/clubs'; ?>" class="btn btn-danger w-100">Accéder</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo isset($asset) ? $asset('admin/demandes') : '/admin/demandes'; ?>" class="btn btn-danger w-100">Accéder</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo isset($asset) ? $asset('admin/ressources') : '/admin/ressources'; ?>" class="btn btn-danger w-100">Accéder</a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3">
            <div class="card text-center shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="<?php echo isset($asset) ? $asset('admin/statistiques') : '/admin/statistiques'; ?>" class="btn btn-danger w-100">Accéder</a>
                </div>
            </div>
        </div>
    </div>
